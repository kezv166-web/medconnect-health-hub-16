    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
      ...
      <div className="space-y-2">
        <div className="flex items-center gap-3">
          <div className="p-3 rounded-xl bg-gradient-to-br from-destructive/20 to-destructive/5 border border-destructive/10">
        ...
        <CardContent className="space-y-6">
          <div className="space-y-5">
            <div className="space-y-2.5">
              ...
              <Input
                ...
                className="h-11 transition-all duration-200 focus:ring-2 focus:ring-destructive/20"
              />
            </div>
          ...
          <div className="pt-4">
            <Button 
              ...
              className="w-full sm:w-auto h-11 px-8 bg-gradient-to-r from-destructive to-destructive/90 hover:from-destructive/90 hover:to-destructive shadow-md hover:shadow-lg transition-all duration-200"
            >
                ...
                <div className="space-y-2">
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1.5 ml-1">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Your hospital profile and all associated information</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-destructive mt-0.5">•</span>
                      <span>All resource management data and doctor roster</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-destructive mt-0.5">•</span>
              ...
              <AlertDialogContent className="max-w-md">
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription className="text-base leading-relaxed pt-2">
                    This will <span className="font-semibold text-destructive">permanently delete</span> your hospital account 
