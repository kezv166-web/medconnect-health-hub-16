                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value) =>
                            form.setValue(`medicines.${index}.frequency`, value)
                          }
                        >
                          <SelectTrigger>
                            <SelectValue />
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value) =>
                            form.setValue(`medicines.${index}.timings`, value)
                          }
                        >
                          <SelectTrigger>
                            <SelectValue />
                      ...
                      <div>
                        ...
                        <Input
                          type="number"
                          {...form.register(`medicines.${index}.duration_days`, {
                            valueAsNumber: true,
                          })}
                          placeholder="30"
                        />
                      ...
                      <div>
                        ...
                        <Input
                          type="number"
                          {...form.register(`medicines.${index}.quantity_remaining`, {
                            valueAsNumber: true,
                          })}
                          placeholder="20"
                        />
